...
use {
    ...
    std::{
        ...
        fs::read_to_string, //[BINGO]
        ops::{
            Bound::{Included, Unbounded},
            Deref,
        },
        path::Path, //[BINGO]
        time::SystemTime, //[BINGO]
    },
    thiserror::Error,
};
...
impl Tower {
    ...
    pub(crate) fn collect_vote_lockouts(
        ...
        for (&key, (voted_stake, account)) in vote_accounts.iter() {
            ...
            vote_state.process_next_vote_slot(bank_slot, true); //[BINGO ?]
    ...
    pub fn record_bank_vote(&mut self, bank: &Bank, pop_expired: bool) -> Option<Slot> { //[BINGO]
    ...
    pub fn update_config(&mut self) {
        ...
        if config_check_seconds >= (self.last_config_check_seconds + 60) {
            ...
            match read_to_string(&Path::new("/home/solana/mostly_confirmed_threshold")) { //[BINGO]
                Ok(s) => {
                    warn!("[BINGO] Found config file"); //[BINGO]
                    let split = s
                        .strip_suffix("\n")
                        .unwrap_or("")
                        .split_whitespace()
    ...
    fn record_bank_vote_and_update_lockouts(
        ...
        self.vote_state.process_next_vote_slot(vote_slot, pop_expired); //[BINGO]
    ...
    pub fn record_vote(&mut self, slot: Slot, hash: Hash) -> Option<Slot> {
        self.record_bank_vote_and_update_lockouts(slot, hash, true, Hash::default(), true) //[BINGO]
    }
    ...
    pub fn pop_votes_locked_out_at(&self, new_votes: &mut Vec<Slot>, slot: Slot) {
        ...
        for i in 0..new_votes.len() {
            ...
            vote_state.process_next_vote_slot(new_votes[i], true); //[BINGO]
