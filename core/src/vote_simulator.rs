...
impl VoteSimulator {
            ...
            for (pubkey, vote) in cluster_votes.iter() {
                if vote.contains(&parent) {
                        ...
                        parent_bank.get_vote_account(&keypairs.vote_keypair.pubkey())
                    {
                        ...
                        vote_state.process_next_vote_slot(parent, true); // [BINGO ?]
                        TowerSync::new(
                            vote_state.votes,
    ...
    pub fn simulate_vote(
        ...
        let mut last_logged_vote_slot = 0; //[BINGO]
        let SelectVoteAndResetForkResult {
            ...
            &mut last_logged_vote_slot, //[BINGO]
        );
        ...
        let new_root = tower.record_bank_vote(&vote_bank, true); //[BINGO]
